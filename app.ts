...
const d1 = new DataSet(root + 'owls15.csv', root + 'owls15-schema.json', 'type', 66);
// const d2 = new DataSet(root + 'illness.csv', root + 'illness-schema.json', 'test_result', 66);
// const d3 = new DataSet(root + 'tennis.csv', root + 'tennis-schema.json', 'PlayTennis', 66);
const tick = Date.now();
